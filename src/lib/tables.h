...
#else
#define PACK(a, b, c, d) ((b) << 24) | ((c) << 16) | ((d) << 8) | (a)
#endif
...
static const byte_t rcon[10] = {
	0x01, 0x02, 0x04, 0x08,
	0x10, 0x20, 0x40, 0x80,
	0x1b, 0x36
};

/** Look-up table for "Multiplication" by 0x0e, 0x0b, 0x0d, 0x09.
 * This is generated by using Ruby script "extras/gen_lut.rb".
 */
static const uint32_t inv_mult[256] = {
	PACK(0x00, 0x00, 0x00, 0x00), PACK(0x0e, 0x0b, 0x0d, 0x09),
	PACK(0x1c, 0x16, 0x1a, 0x12), PACK(0x12, 0x1d, 0x17, 0x1b),
	PACK(0x38, 0x2c, 0x34, 0x24), PACK(0x36, 0x27, 0x39, 0x2d),
	PACK(0x24, 0x3a, 0x2e, 0x36), PACK(0x2a, 0x31, 0x23, 0x3f),
	PACK(0x70, 0x58, 0x68, 0x48), PACK(0x7e, 0x53, 0x65, 0x41),
	PACK(0x6c, 0x4e, 0x72, 0x5a), PACK(0x62, 0x45, 0x7f, 0x53),
	PACK(0x48, 0x74, 0x5c, 0x6c), PACK(0x46, 0x7f, 0x51, 0x65),
	PACK(0x54, 0x62, 0x46, 0x7e), PACK(0x5a, 0x69, 0x4b, 0x77),
	PACK(0xe0, 0xb0, 0xd0, 0x90), PACK(0xee, 0xbb, 0xdd, 0x99),
	PACK(0xfc, 0xa6, 0xca, 0x82), PACK(0xf2, 0xad, 0xc7, 0x8b),
	PACK(0xd8, 0x9c, 0xe4, 0xb4), PACK(0xd6, 0x97, 0xe9, 0xbd),
	PACK(0xc4, 0x8a, 0xfe, 0xa6), PACK(0xca, 0x81, 0xf3, 0xaf),
	PACK(0x90, 0xe8, 0xb8, 0xd8), PACK(0x9e, 0xe3, 0xb5, 0xd1),
	PACK(0x8c, 0xfe, 0xa2, 0xca), PACK(0x82, 0xf5, 0xaf, 0xc3),
	PACK(0xa8, 0xc4, 0x8c, 0xfc), PACK(0xa6, 0xcf, 0x81, 0xf5),
	PACK(0xb4, 0xd2, 0x96, 0xee), PACK(0xba, 0xd9, 0x9b, 0xe7),
	PACK(0xdb, 0x7b, 0xbb, 0x3b), PACK(0xd5, 0x70, 0xb6, 0x32),
	PACK(0xc7, 0x6d, 0xa1, 0x29), PACK(0xc9, 0x66, 0xac, 0x20),
	PACK(0xe3, 0x57, 0x8f, 0x1f), PACK(0xed, 0x5c, 0x82, 0x16),
	PACK(0xff, 0x41, 0x95, 0x0d), PACK(0xf1, 0x4a, 0x98, 0x04),
	PACK(0xab, 0x23, 0xd3, 0x73), PACK(0xa5, 0x28, 0xde, 0x7a),
	PACK(0xb7, 0x35, 0xc9, 0x61), PACK(0xb9, 0x3e, 0xc4, 0x68),
	PACK(0x93, 0x0f, 0xe7, 0x57), PACK(0x9d, 0x04, 0xea, 0x5e),
	PACK(0x8f, 0x19, 0xfd, 0x45), PACK(0x81, 0x12, 0xf0, 0x4c),
	PACK(0x3b, 0xcb, 0x6b, 0xab), PACK(0x35, 0xc0, 0x66, 0xa2),
	PACK(0x27, 0xdd, 0x71, 0xb9), PACK(0x29, 0xd6, 0x7c, 0xb0),
	PACK(0x03, 0xe7, 0x5f, 0x8f), PACK(0x0d, 0xec, 0x52, 0x86),
	PACK(0x1f, 0xf1, 0x45, 0x9d), PACK(0x11, 0xfa, 0x48, 0x94),
	PACK(0x4b, 0x93, 0x03, 0xe3), PACK(0x45, 0x98, 0x0e, 0xea),
	PACK(0x57, 0x85, 0x19, 0xf1), PACK(0x59, 0x8e, 0x14, 0xf8),
	PACK(0x73, 0xbf, 0x37, 0xc7), PACK(0x7d, 0xb4, 0x3a, 0xce),
	PACK(0x6f, 0xa9, 0x2d, 0xd5), PACK(0x61, 0xa2, 0x20, 0xdc),
	PACK(0xad, 0xf6, 0x6d, 0x76), PACK(0xa3, 0xfd, 0x60, 0x7f),
	PACK(0xb1, 0xe0, 0x77, 0x64), PACK(0xbf, 0xeb, 0x7a, 0x6d),
	PACK(0x95, 0xda, 0x59, 0x52), PACK(0x9b, 0xd1, 0x54, 0x5b),
	PACK(0x89, 0xcc, 0x43, 0x40), PACK(0x87, 0xc7, 0x4e, 0x49),
	PACK(0xdd, 0xae, 0x05, 0x3e), PACK(0xd3, 0xa5, 0x08, 0x37),
	PACK(0xc1, 0xb8, 0x1f, 0x2c), PACK(0xcf, 0xb3, 0x12, 0x25),
	PACK(0xe5, 0x82, 0x31, 0x1a), PACK(0xeb, 0x89, 0x3c, 0x13),
	PACK(0xf9, 0x94, 0x2b, 0x08), PACK(0xf7, 0x9f, 0x26, 0x01),
	PACK(0x4d, 0x46, 0xbd, 0xe6), PACK(0x43, 0x4d, 0xb0, 0xef),
	PACK(0x51, 0x50, 0xa7, 0xf4), PACK(0x5f, 0x5b, 0xaa, 0xfd),
	PACK(0x75, 0x6a, 0x89, 0xc2), PACK(0x7b, 0x61, 0x84, 0xcb),
	PACK(0x69, 0x7c, 0x93, 0xd0), PACK(0x67, 0x77, 0x9e, 0xd9),
	PACK(0x3d, 0x1e, 0xd5, 0xae), PACK(0x33, 0x15, 0xd8, 0xa7),
	PACK(0x21, 0x08, 0xcf, 0xbc), PACK(0x2f, 0x03, 0xc2, 0xb5),
	PACK(0x05, 0x32, 0xe1, 0x8a), PACK(0x0b, 0x39, 0xec, 0x83),
	PACK(0x19, 0x24, 0xfb, 0x98), PACK(0x17, 0x2f, 0xf6, 0x91),
	PACK(0x76, 0x8d, 0xd6, 0x4d), PACK(0x78, 0x86, 0xdb, 0x44),
	PACK(0x6a, 0x9b, 0xcc, 0x5f), PACK(0x64, 0x90, 0xc1, 0x56),
	PACK(0x4e, 0xa1, 0xe2, 0x69), PACK(0x40, 0xaa, 0xef, 0x60),
	PACK(0x52, 0xb7, 0xf8, 0x7b), PACK(0x5c, 0xbc, 0xf5, 0x72),
	PACK(0x06, 0xd5, 0xbe, 0x05), PACK(0x08, 0xde, 0xb3, 0x0c),
	PACK(0x1a, 0xc3, 0xa4, 0x17), PACK(0x14, 0xc8, 0xa9, 0x1e),
	PACK(0x3e, 0xf9, 0x8a, 0x21), PACK(0x30, 0xf2, 0x87, 0x28),
	PACK(0x22, 0xef, 0x90, 0x33), PACK(0x2c, 0xe4, 0x9d, 0x3a),
	PACK(0x96, 0x3d, 0x06, 0xdd), PACK(0x98, 0x36, 0x0b, 0xd4),
	PACK(0x8a, 0x2b, 0x1c, 0xcf), PACK(0x84, 0x20, 0x11, 0xc6),
	PACK(0xae, 0x11, 0x32, 0xf9), PACK(0xa0, 0x1a, 0x3f, 0xf0),
	PACK(0xb2, 0x07, 0x28, 0xeb), PACK(0xbc, 0x0c, 0x25, 0xe2),
	PACK(0xe6, 0x65, 0x6e, 0x95), PACK(0xe8, 0x6e, 0x63, 0x9c),
	PACK(0xfa, 0x73, 0x74, 0x87), PACK(0xf4, 0x78, 0x79, 0x8e),
	PACK(0xde, 0x49, 0x5a, 0xb1), PACK(0xd0, 0x42, 0x57, 0xb8),
	PACK(0xc2, 0x5f, 0x40, 0xa3), PACK(0xcc, 0x54, 0x4d, 0xaa),
	PACK(0x41, 0xf7, 0xda, 0xec), PACK(0x4f, 0xfc, 0xd7, 0xe5),
	PACK(0x5d, 0xe1, 0xc0, 0xfe), PACK(0x53, 0xea, 0xcd, 0xf7),
	PACK(0x79, 0xdb, 0xee, 0xc8), PACK(0x77, 0xd0, 0xe3, 0xc1),
	PACK(0x65, 0xcd, 0xf4, 0xda), PACK(0x6b, 0xc6, 0xf9, 0xd3),
	PACK(0x31, 0xaf, 0xb2, 0xa4), PACK(0x3f, 0xa4, 0xbf, 0xad),
	PACK(0x2d, 0xb9, 0xa8, 0xb6), PACK(0x23, 0xb2, 0xa5, 0xbf),
	PACK(0x09, 0x83, 0x86, 0x80), PACK(0x07, 0x88, 0x8b, 0x89),
	PACK(0x15, 0x95, 0x9c, 0x92), PACK(0x1b, 0x9e, 0x91, 0x9b),
	PACK(0xa1, 0x47, 0x0a, 0x7c), PACK(0xaf, 0x4c, 0x07, 0x75),
	PACK(0xbd, 0x51, 0x10, 0x6e), PACK(0xb3, 0x5a, 0x1d, 0x67),
	PACK(0x99, 0x6b, 0x3e, 0x58), PACK(0x97, 0x60, 0x33, 0x51),
	PACK(0x85, 0x7d, 0x24, 0x4a), PACK(0x8b, 0x76, 0x29, 0x43),
	PACK(0xd1, 0x1f, 0x62, 0x34), PACK(0xdf, 0x14, 0x6f, 0x3d),
	PACK(0xcd, 0x09, 0x78, 0x26), PACK(0xc3, 0x02, 0x75, 0x2f),
	PACK(0xe9, 0x33, 0x56, 0x10), PACK(0xe7, 0x38, 0x5b, 0x19),
	PACK(0xf5, 0x25, 0x4c, 0x02), PACK(0xfb, 0x2e, 0x41, 0x0b),
	PACK(0x9a, 0x8c, 0x61, 0xd7), PACK(0x94, 0x87, 0x6c, 0xde),
	PACK(0x86, 0x9a, 0x7b, 0xc5), PACK(0x88, 0x91, 0x76, 0xcc),
	PACK(0xa2, 0xa0, 0x55, 0xf3), PACK(0xac, 0xab, 0x58, 0xfa),
	PACK(0xbe, 0xb6, 0x4f, 0xe1), PACK(0xb0, 0xbd, 0x42, 0xe8),
	PACK(0xea, 0xd4, 0x09, 0x9f), PACK(0xe4, 0xdf, 0x04, 0x96),
	PACK(0xf6, 0xc2, 0x13, 0x8d), PACK(0xf8, 0xc9, 0x1e, 0x84),
	PACK(0xd2, 0xf8, 0x3d, 0xbb), PACK(0xdc, 0xf3, 0x30, 0xb2),
	PACK(0xce, 0xee, 0x27, 0xa9), PACK(0xc0, 0xe5, 0x2a, 0xa0),
	PACK(0x7a, 0x3c, 0xb1, 0x47), PACK(0x74, 0x37, 0xbc, 0x4e),
	PACK(0x66, 0x2a, 0xab, 0x55), PACK(0x68, 0x21, 0xa6, 0x5c),
	PACK(0x42, 0x10, 0x85, 0x63), PACK(0x4c, 0x1b, 0x88, 0x6a),
	PACK(0x5e, 0x06, 0x9f, 0x71), PACK(0x50, 0x0d, 0x92, 0x78),
	PACK(0x0a, 0x64, 0xd9, 0x0f), PACK(0x04, 0x6f, 0xd4, 0x06),
	PACK(0x16, 0x72, 0xc3, 0x1d), PACK(0x18, 0x79, 0xce, 0x14),
	PACK(0x32, 0x48, 0xed, 0x2b), PACK(0x3c, 0x43, 0xe0, 0x22),
	PACK(0x2e, 0x5e, 0xf7, 0x39), PACK(0x20, 0x55, 0xfa, 0x30),
	PACK(0xec, 0x01, 0xb7, 0x9a), PACK(0xe2, 0x0a, 0xba, 0x93),
	PACK(0xf0, 0x17, 0xad, 0x88), PACK(0xfe, 0x1c, 0xa0, 0x81),
	PACK(0xd4, 0x2d, 0x83, 0xbe), PACK(0xda, 0x26, 0x8e, 0xb7),
	PACK(0xc8, 0x3b, 0x99, 0xac), PACK(0xc6, 0x30, 0x94, 0xa5),
	PACK(0x9c, 0x59, 0xdf, 0xd2), PACK(0x92, 0x52, 0xd2, 0xdb),
	PACK(0x80, 0x4f, 0xc5, 0xc0), PACK(0x8e, 0x44, 0xc8, 0xc9),
	PACK(0xa4, 0x75, 0xeb, 0xf6), PACK(0xaa, 0x7e, 0xe6, 0xff),
	PACK(0xb8, 0x63, 0xf1, 0xe4), PACK(0xb6, 0x68, 0xfc, 0xed),
	PACK(0x0c, 0xb1, 0x67, 0x0a), PACK(0x02, 0xba, 0x6a, 0x03),
	PACK(0x10, 0xa7, 0x7d, 0x18), PACK(0x1e, 0xac, 0x70, 0x11),
	PACK(0x34, 0x9d, 0x53, 0x2e), PACK(0x3a, 0x96, 0x5e, 0x27),
	PACK(0x28, 0x8b, 0x49, 0x3c), PACK(0x26, 0x80, 0x44, 0x35),
	PACK(0x7c, 0xe9, 0x0f, 0x42), PACK(0x72, 0xe2, 0x02, 0x4b),
	PACK(0x60, 0xff, 0x15, 0x50), PACK(0x6e, 0xf4, 0x18, 0x59),
	PACK(0x44, 0xc5, 0x3b, 0x66), PACK(0x4a, 0xce, 0x36, 0x6f),
	PACK(0x58, 0xd3, 0x21, 0x74), PACK(0x56, 0xd8, 0x2c, 0x7d),
	PACK(0x37, 0x7a, 0x0c, 0xa1), PACK(0x39, 0x71, 0x01, 0xa8),
	PACK(0x2b, 0x6c, 0x16, 0xb3), PACK(0x25, 0x67, 0x1b, 0xba),
	PACK(0x0f, 0x56, 0x38, 0x85), PACK(0x01, 0x5d, 0x35, 0x8c),
	PACK(0x13, 0x40, 0x22, 0x97), PACK(0x1d, 0x4b, 0x2f, 0x9e),
	PACK(0x47, 0x22, 0x64, 0xe9), PACK(0x49, 0x29, 0x69, 0xe0),
	PACK(0x5b, 0x34, 0x7e, 0xfb), PACK(0x55, 0x3f, 0x73, 0xf2),
	PACK(0x7f, 0x0e, 0x50, 0xcd), PACK(0x71, 0x05, 0x5d, 0xc4),
	PACK(0x63, 0x18, 0x4a, 0xdf), PACK(0x6d, 0x13, 0x47, 0xd6),
	PACK(0xd7, 0xca, 0xdc, 0x31), PACK(0xd9, 0xc1, 0xd1, 0x38),
	PACK(0xcb, 0xdc, 0xc6, 0x23), PACK(0xc5, 0xd7, 0xcb, 0x2a),
	PACK(0xef, 0xe6, 0xe8, 0x15), PACK(0xe1, 0xed, 0xe5, 0x1c),
	PACK(0xf3, 0xf0, 0xf2, 0x07), PACK(0xfd, 0xfb, 0xff, 0x0e),
	PACK(0xa7, 0x92, 0xb4, 0x79), PACK(0xa9, 0x99, 0xb9, 0x70),
	PACK(0xbb, 0x84, 0xae, 0x6b), PACK(0xb5, 0x8f, 0xa3, 0x62),
	PACK(0x9f, 0xbe, 0x80, 0x5d), PACK(0x91, 0xb5, 0x8d, 0x54),
	PACK(0x83, 0xa8, 0x9a, 0x4f), PACK(0x8d, 0xa3, 0x97, 0x46),
};

static const uint32_t inv_mult_inv_sbox[256] = {
...
static const uint32_t inv_mult_rot24_inv_sbox[256] = {
...
static const uint32_t inv_mult_rot16_inv_sbox[256] = {
...
static const uint32_t inv_mult_rot8_inv_sbox[256] = {
